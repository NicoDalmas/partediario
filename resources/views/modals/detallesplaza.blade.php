...
<div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'limpieza', 'class'=>'labelazul', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Jardinería:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'jardineria', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '' ,array('id' => 'arbolado', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Juegos:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'juegos', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '' ,array('id' => 'bebederos', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Estaciones Aerobbicas:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'aerobicas', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'bicicleteros', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Cercos:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'cercos', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'riego', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Cartelería:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'carteleria', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'mobiliario', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Mastil:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'mastil', 'class'=>'form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'arenero', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Caminos:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'caminos', 'class'=>'form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'veredas', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Luminarias:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'luminarias', 'class'=>'form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'esculturas', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
					{!! Form::label(null, 'Playón:', array('class' => 'control-label col-sm-2')) !!}
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'playon', 'class'=>'form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-4">
						{!! Form::label(null, '', array('id' => 'cestos', 'class'=>' form-control', 'style' => 'width: 50%')) 
                        !!}
					</div>
